...
The following examples were generated by the LiteGPT-25M model (~25M parameters) trained on ~1B tokens from FineWeb and TinyStories.

All examples were generated using the evaluation script at `evals/generate.py`.
...
- **Output:** class LinkedList: - LinkedList: LinkedList: LinkedList: LinkedList: LinkedList: LinkedList: LinkedList: LinkedList: LinkedList: LinkedList: LinkedList: LinkedList: LinkedList: LinkedList: LinkedList: LinkedList: LinkedList: LinkedList: LinkedList: LinkedList: LinkedList: LinkedList: LinkedList: LinkedList: LinkedList: LinkedList: LinkedList: LinkedList: LinkedList: LinkedList: LinkedList: LinkedList: LinkedList: LinkedList: LinkedList: LinkedList: LinkedList: LinkedList: LinkedList: LinkedList: LinkedList: LinkedList: LinkedList: LinkedList: LinkedList: LinkedList: LinkedList: LinkedList: Linked
...
```bash
python evals/generate.py --checkpoint ./checkpoints/best --eval
```

This will run through all preset prompts and save results to `./results/evals/`.
